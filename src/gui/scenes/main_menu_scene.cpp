...
void MainMenuScene::updateLayout()
{
  ...
  buttonManager->updateButtonPosition(
      1, {startX, startY + (btnHeight + padding), btnWidth, btnHeight});
  buttonManager->updateButtonPosition(
      2, {startX, startY + 2 * (btnHeight + padding), btnWidth, btnHeight});
  buttonManager->updateButtonPosition(
      3, {startX, startY + 3 * (btnHeight + padding), btnWidth, btnHeight});
}
